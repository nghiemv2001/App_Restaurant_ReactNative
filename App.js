...
import ChartStaff from './src/screens/Chart/ChartStaff'
//inventory
...
import { SateProvider } from './src/component/sateContext';
        ...
        <SateProvider >
          <Stack.Navigator>
           <Stack.Screen name="Wellcome" component={Welcome} options={{
            ...
            <Stack.Screen name="ChartStaff" component={ChartStaff} options={{
              headerShown: false
            }} />
