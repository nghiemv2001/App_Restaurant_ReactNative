...
const ListProductStep1 = () => {
  ...
  const [showModalConfirmAll, setShowModalConfirmDeleteAll] = useState(false)
  ...
  const renderlist = ((item) => {
    return (
      <View>
        {
          item.status == "2" ? <View style={{ marginBottom: 3, backgroundColor: '#EDF6D8', paddingVertical: 5, paddingRight: 200, paddingLeft: 5, flexDirection: 'row', borderTopWidth: 1 }}>
  ...
  return (
    <View style={{ backgroundColor: '#EDF6D8', height: '100%' }}>
      ...
      >
        <View style={styles.centeredView}>
          ...
          <View style={{
            ...
            <Text style={{ fontSize: 22, fontWeight: '900', marginTop: -10 }}>Delete All Cooked</Text>
            <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', width: '100%', height: '40%', alignItems: 'flex-end' }}>
              <TouchableOpacity
                onPress={() => { setShowModalConfirmDeleteAll(false) }}
              ...
              <TouchableOpacity
                onPress={() => { 
                  DeteleAllCook() 
                  setShowModalConfirmDeleteAll(false)
                }}
      ...
      <View style={{ flexDirection: 'row', justifyContent:'space-between', alignItems:'center', paddingHorizontal: 30}}>
        <Text></Text>
        <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'gray', widt: "100%", textAlign: 'center', marginTop: 30 }}>COOKED</Text>
        <TouchableOpacity 
        onPress={ ()=>{setShowModalConfirmDeleteAll(true)}}
        style={{ marginTop:30 }}>
